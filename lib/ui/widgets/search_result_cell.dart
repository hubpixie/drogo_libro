...
class SearchResultCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () => this.onCellSelected?.call({"drogoItem": this.drogoItem}),
        child: Card(
          child: new Column(
  ...
  List<Widget> _buildRow(BuildContext context) {
      ...
      children: <Widget>[
        ...
        new Padding(
          ...
          child: new Text(this.drogoItem?.dispeningDate ?? '',
              style: new TextStyle(
                  backgroundColor: this.searchedType == SearchType.dispeningDate
                      ? AppColors.searchedResultMarkColor
                      : Colors.white)),
        ),
      ],
    ));
    Row drogoRow = new Row(
      children: <Widget>[
        ...
        new Text(this.drogoItem?.drogoSummaryList?.first.drogoName ?? '',
            style: new TextStyle(
                backgroundColor: this.searchedType == SearchType.drogoName
                    ? AppColors.searchedResultMarkColor
                    : Colors.white)),
        new Padding(padding: EdgeInsets.all(4.0)),
        new Text(
        ...
        new Padding(padding: EdgeInsets.all(4.0)),
        new Text(
          "${this.drogoItem?.drogoSummaryList?.first.days} 日分",
          softWrap: true,
          maxLines: 1,
        ),
      ],
          ...
          new Row(
            children: <Widget>[
              ...
              new Text(
                '(内服)',
                style:
                    new TextStyle(color: AppColors.labelColor, fontSize: 13.0),
              ),
              new Padding(padding: EdgeInsets.all(4.0)),
              new Text("1 日 ${this.drogoItem?.drogoSummaryList?.first.times}回　",
                  style: new TextStyle(
                      backgroundColor: this.searchedType == SearchType.times
                          ? AppColors.searchedResultMarkColor
                          : Colors.white)),
              new Text(
                  "${DrogoUsages.values[this.drogoItem?.drogoSummaryList?.first.usage ?? 0].name}",
                  style: new TextStyle(
                      backgroundColor: this.searchedType == SearchType.usage
                          ? AppColors.searchedResultMarkColor
                          : Colors.white)),
              new Padding(padding: EdgeInsets.all(6.0)),
              new Text(
                "1 回 ${this.drogoItem?.drogoSummaryList?.first.amount}錠",
                softWrap: true,
                maxLines: 1,
              ),
            ],
          ...
          new Row(
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: new Text(this.drogoItem?.medicalInstituteName ?? '',
                    softWrap: false,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: new TextStyle(
                        backgroundColor:
                            this.searchedType == SearchType.medicalInstituteName
                                ? AppColors.searchedResultMarkColor
                                : Colors.white)),
              ),
              new Padding(padding: EdgeInsets.all(4.0)),
          ...
          new Row(
            children: <Widget>[
              ...
              SizedBox(
                width: screenWidth >= 320 && screenWidth <= 360 ? 110 : 140,
                child: new Text(
                  this.drogoItem?.medicalInstituteName ?? '',
                  softWrap: false,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.left,
                ),
              ...
              SizedBox(
                ...
                child: new Text(this.drogoItem?.doctorName ?? '',
                    softWrap: false,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style: new TextStyle(
                        backgroundColor:
                            this.searchedType == SearchType.doctorName
                                ? AppColors.searchedResultMarkColor
                                : Colors.white)),
              ),
            ],
