...
class SuplementInfoPresentCell extends StatefulWidget {
  ...
  @override
  _SuplementInfoPresentCellState createState() =>
      _SuplementInfoPresentCellState();
}
...
class _SuplementInfoPresentCellState extends State<SuplementInfoPresentCell> {
  ...
  Widget build(BuildContext context) {
    ...
    _itemValue.suplementEtcText =
        _itemValue.suplementEtcText != null ? _itemValue.suplementEtcText : '';
          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ...
                Checkbox(
                  ...
                  value: _itemValue
                      .suplementTypeList?[SuplementTypes.vitaminK.index],
            ...
            Row(
              children: <Widget>[
                ...
                Checkbox(
                  activeColor: Colors.black,
                  value: _itemValue.suplementTypeList?[
                      SuplementTypes.gingyoLeafExtract.index],
                  onChanged: (bool? value) => _checkboxOnChanged(
            ...
            Row(children: <Widget>[
              ...
              Checkbox(
                ...
                onChanged: (bool? value) => _checkboxOnChanged(
                    SuplementTypes.etc.index, value ?? false),
              ),
              Text(
  ...
  void _updateCheckTextColor() {
    for (int idx = 0; idx < _lableColorList.length; idx++) {
      _lableColorList[idx] = _itemValue.suplementTypeList != null &&
              (_itemValue.suplementTypeList?[idx] ?? false)
          ? Colors.black
          : Colors.black38;
    }
  }
