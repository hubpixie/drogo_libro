...
class WeatherFunctionCell extends StatefulWidget {
  ...
  WeatherFunctionCell(
      {this.itemValue, required this.temprtUnit, this.onPresentWeeklyForecast});

  @override
  _WeatherDetailPresentCellState createState() =>
      _WeatherDetailPresentCellState();
}
    ...
    return Container(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: TextButton(
            child: Text('週間予報', style: TextStyle(fontSize: 18.0)),
        ...
        Spacer(),
        Text('${_itemValue?.feelsLike?.as(widget.temprtUnit).round()}°',
