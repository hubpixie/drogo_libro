...
class WeeklyForecastCell extends StatefulWidget {
  ...
  WeeklyForecastCell({this.weeklyForecastValue, this.temprtUnit});
...
class _WeeklyForecastCellState extends State<WeeklyForecastCell> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          Text(_weeklyForecastValue != null && _weeklyForecastValue.isNotEmpty ? '${_weeklyForecastValue.first.getDataFormattedString()} 〜 ${_weeklyForecastValue.last.getDataFormattedString()}' : ''),
          Expanded(
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Container(
          //width: 50,
          height: 70,
          child: Icon( weeklyValue != null  ?  weeklyValue.getIconData() : null,
            color: Colors.black45,
            size: 40,
            ),
        ),
        Text('${weeklyValue.maxTemperatureOfForecast.as(_temprtUnit).round()}°'),
        Text('${weeklyValue.minTemperatureOfForecast.as(_temprtUnit).round()}°',
