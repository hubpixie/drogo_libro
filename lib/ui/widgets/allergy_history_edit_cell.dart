      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            Checkbox(
              value:
                  _itemValue?.allergyHistoryTypeList?[AllergyTypes.milk.index],
              onChanged: (bool? value) =>
                  _checkboxOnChanged(AllergyTypes.milk.index, value ?? false),
            ),
            Container(
            ...
            Checkbox(
              value:
                  _itemValue?.allergyHistoryTypeList?[AllergyTypes.egg.index],
              onChanged: (bool? value) =>
                  _checkboxOnChanged(AllergyTypes.egg.index, value ?? false),
            ),
            Text(
    ...
    setState(() {
      ...
      if (!value) {
        _etcTextController.text =
            (AllergyTypes.etc.index == index) ? '' : _etcTextController.text;
      }
