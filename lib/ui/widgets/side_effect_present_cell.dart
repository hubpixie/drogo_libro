    ...
    return Card(
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                ...
                child: Text('おくすり名', textAlign: TextAlign.center,),
              ),
              Container(
                alignment: Alignment.center,
                //width: _screenWidth - 220,
                padding: EdgeInsets.symmetric(horizontal: 10.0),
                child: Text('[いつごろ]症状', textAlign: TextAlign.center,),
              ),
            ]
          ),
          Container(
          ...
          _itemValue.sideEffectList.isNotEmpty ? Container(
          ...
          Container(
            ...
            alignment: Alignment.center,
            child: Text('該当データがありません', textAlign: TextAlign.center,),
          ),
        ]
      )
    );
