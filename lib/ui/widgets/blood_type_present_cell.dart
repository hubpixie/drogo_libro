...
class _BloodTypePresentCellState extends State<BloodTypePresentCell> {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 20.0,
                        color: _lableColorList?[BloodTypes.a.index]),
                  ),
                ),
                Radio(
                  activeColor: Colors.black,
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 20.0,
                        color: _lableColorList?[BloodTypes.b.index]),
                  ),
                ),
                Radio(
                  activeColor: Colors.black,
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 20.0,
                        color: _lableColorList?[BloodTypes.ab.index]),
                  ),
                ),
              ],
            ),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 20.0,
                        color: _lableColorList?[BloodTypes.o.index]),
                  ),
                ),
                Radio(
                  activeColor: Colors.black,
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 20.0,
                        color: _lableColorList?[BloodTypes.rhPlus.index]),
                  ),
                ),
                Radio(
                  activeColor: Colors.black,
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 20.0,
                        color: _lableColorList?[BloodTypes.rhMinus.index]),
                  ),
                ),
              ],
            ),
  ...
  void _updateRadioTextColor() {
    ...
    if (_itemValue != null && _itemValue?.bloodType != null) {
      _lableColorList?[(_itemValue?.bloodType?.index) ?? 0] = Colors.black;
    }
  }
