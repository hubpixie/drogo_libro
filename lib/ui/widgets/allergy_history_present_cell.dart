...
class AllergyHistoryPresentCell extends StatefulWidget {
  ...
  @override
  _AllergyHistoryPresentCellState createState() =>
      _AllergyHistoryPresentCellState();
}
...
class _AllergyHistoryPresentCellState extends State<AllergyHistoryPresentCell> {
  ...
  Widget build(BuildContext context) {
    ...
    _itemValue?.allergyHistoryTypeList =
        _itemValue?.allergyHistoryTypeList != null
            ? _itemValue?.allergyHistoryTypeList
            : List.filled(AllergyTypes.values.length, false);
    _itemValue?.allergyEtcText =
        _itemValue?.allergyEtcText != null ? _itemValue?.allergyEtcText : '';
            ...
            Row(
              children: <Widget>[
                ...
                Checkbox(
                  ...
                  value: _itemValue
                      ?.allergyHistoryTypeList?[AllergyTypes.milk.index],
                  onChanged: (bool? value) => _checkboxOnChanged(
                      AllergyTypes.milk.index, value ?? false),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    AllergyTypes.milk.name,
                    style: TextStyle(
                        fontSize: 16.0,
                        color: _lableColorList?[AllergyTypes.milk.index]),
                  ),
                ),
                Checkbox(
                  activeColor: Colors.black,
                  value: _itemValue
                      ?.allergyHistoryTypeList?[AllergyTypes.egg.index],
                  onChanged: (bool? value) => _checkboxOnChanged(
                      AllergyTypes.egg.index, value ?? false),
                ),
                Text(
                  AllergyTypes.egg.name,
                  style: TextStyle(
                      fontSize: 16.0,
                      color: _lableColorList?[AllergyTypes.egg.index]),
                ),
                Checkbox(
                  activeColor: Colors.black,
                  value: _itemValue
                      ?.allergyHistoryTypeList?[AllergyTypes.pollinosis.index],
                  onChanged: (bool? value) => _checkboxOnChanged(
                      AllergyTypes.pollinosis.index, value ?? false),
                ),
                Text(
                  AllergyTypes.pollinosis.name,
                  style: TextStyle(
                      fontSize: 16.0,
                      color: _lableColorList?[AllergyTypes.pollinosis.index]),
                ),
              ],
            ),
            Row(children: <Widget>[
              ...
              Checkbox(
                activeColor: Colors.black,
                value:
                    _itemValue?.allergyHistoryTypeList?[AllergyTypes.etc.index],
                onChanged: (bool? value) =>
                    _checkboxOnChanged(AllergyTypes.etc.index, value ?? false),
              ),
              Text(
                AllergyTypes.etc.name,
                style: TextStyle(
                    fontSize: 16.0,
  ...
  void _updateCheckTextColor() {
    for (int idx = 0; idx < (_lableColorList?.length ?? 0); idx++) {
      _lableColorList?[idx] = _itemValue?.allergyHistoryTypeList != null &&
              (_itemValue?.allergyHistoryTypeList?[idx] ?? false)
          ? Colors.black
          : Colors.black38;
    }
  }
