...
class WeatherContentCell extends StatefulWidget {
  ...
  WeatherContentCell(
      {this.itemValue, required this.temprtUnit, this.onCellEditing});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      children: <Widget>[
        ...
        Spacer(),
        Text('${_itemValue?.temperature?.as(widget.temprtUnit).round()}°',
            style: TextStyle(fontSize: 40.0)),
        Spacer(),
        Container(
            child: Icon(
          _itemValue != null ? _itemValue?.getIconData() : null,
        ...
        Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                    '${_itemValue?.maxTemperature?.as(widget.temprtUnit).round()}°',
                    style: TextStyle(fontSize: 16.0)),
                Text(
                    '${_itemValue?.minTemperature?.as(widget.temprtUnit).round()}°',
