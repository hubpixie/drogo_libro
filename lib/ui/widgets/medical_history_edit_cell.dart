...
class _MedicalHistoryEditCellState extends State<MedicalHistoryEditCell> {
  ...
  late TextEditingController _hdTextController;
  late TextEditingController _etcTextController;
  late FocusNode _hdFocusNode;
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            Checkbox(
              value: _itemValue
                  ?.medicalHistoryTypeList?[MedicalHistoryTypes.glaucoma.index],
              onChanged: (bool? value) => _checkboxOnChanged(
        ...
        Row(
          children: <Widget>[
            ...
            Checkbox(
              value: _itemValue
                  ?.medicalHistoryTypeList?[MedicalHistoryTypes.asthma.index],
              onChanged: (bool? value) => _checkboxOnChanged(
  ...
  void _checkboxOnChanged(int index, bool value) {
    setState(() {
      // 相関チェック
      if (!value) {
        _hdTextController.text = (MedicalHistoryTypes.hd.index == index)
            ? ''
            : _hdTextController.text;
        _etcTextController.text = (MedicalHistoryTypes.etc.index == index)
            ? ''
  ...
  void _hdTextOnEditigComplete() {
    setState(() {
      ...
      _itemValue?.medicalHistoryTypeList?[MedicalHistoryTypes.hd.index] =
          _hdTextController.text.isNotEmpty;
  ...
  void _etcTextOnEditigComplete() {
    setState(() {
      // 入力あり時、該当チェックボックスをONにする
      _itemValue?.medicalHistoryTypeList?[MedicalHistoryTypes.etc.index] =
