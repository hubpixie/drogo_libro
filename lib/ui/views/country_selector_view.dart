...
class CountrySelectorView extends StatefulWidget {
  ...
  CountrySelectorView({this.title, this.countryCode});
...
class _CountrySelectorViewState extends State<CountrySelectorView> {
  ...
  void initState() {
    ...
    _selectedIndex = _countryNameList.indexWhere((element) => element.code == widget.countryCode);
              ...
              children: <Widget>[
                Theme(
                  ...
                  child:  CheckboxListTile(
                    title: Text("${_countryNameList[index].code}　${_countryNameList[index].jpName}", 
