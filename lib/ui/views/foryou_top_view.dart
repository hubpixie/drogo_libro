...
class ForyouTopView extends StatefulWidget {
  final String title;
  ForyouTopView({required this.title});
...
class _ForyouTopViewState extends State<ForyouTopView> {
  //==========================<
  // Const defines
  static const List<String> _kFunctionButtonTextList = [
    "Foryou情報を丸ごと見る",
    "編集方法について",
    "血液型を編集・確認する",
    "既往歴を編集・確認する",
  ...
  static const List<IconData> _kFunctionButtonIconList = [
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.presentForyouAll),
                      ),
                      Container(
                        width: screenWidth / 2,
                        color: Colors.orange[200]?.withAlpha(200),
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.usingForyou),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.editBloodType),
                      ),
                      Container(
                        width: screenWidth,
                        height: screenHeight * 0.4 / 3,
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.editMedicalHistory),
                      ),
                      Container(
                        width: screenWidth,
                        height: screenHeight * 0.4 / 3,
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.editAllergy),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.editSuplements),
                      ),
                      Container(
                        width: screenWidth / 2,
                        color: Colors.orange[700]?.withAlpha(200),
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.editSideEffect),
                      ),
                    ],
                  ),
                ),
  ...
  Widget _buildFunctionButton(
      BuildContext context, FunctionButtonKind buttonKind) {
    List<Widget> wlst = [
      Ink(
      ...
      Align(
        ...
        child: TextButton(
          onPressed: () => _buttonOnTap(context, buttonKind),
          child: Text(
            _kFunctionButtonTextList[buttonKind.index],
    ...
    return [
      FunctionButtonKind.editBloodType,
      FunctionButtonKind.editMedicalHistory,
      FunctionButtonKind.editAllergy
    ].contains(buttonKind)
        ? Row(mainAxisAlignment: MainAxisAlignment.center, children: wlst)
        : Column(mainAxisAlignment: MainAxisAlignment.center, children: wlst);
  }
  ...
  void _buttonOnTap(BuildContext context, FunctionButtonKind buttonKind) {
    switch (buttonKind) {
      case FunctionButtonKind.presentForyouAll:
        Navigator.pushNamed(
            context, ScreenRouteName.presentForyouAll.name ?? "");
        break;
