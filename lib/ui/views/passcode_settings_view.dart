...
class PasscodeSettingsView extends StatefulWidget {
  ...
  PasscodeSettingsView({this.title});
...
class _PasscodeSettingsViewState extends State<PasscodeSettingsView> {
 ...
 Widget _buildInputContent(BuildContext context) {
        ...
        Row(
          children: <Widget>[
            ...
            Radio(
              ...
              onChanged: (_HidesPasscode value) async =>  _savePrefsData(hidesPasscode: value), 
            ),
            Container(
              child: Text('パスコードを表示する', 
        ...
        Row(
          children: [
            Container(
              ...
              child: Text(_passcode != null && _passcode.isNotEmpty ? '' : '未設定の場合、設定してください',
                maxLines: null, 
          ...
          children: [
            Container(
              ...
              child: FlatButton(
                ...
                child: Text(_passcode != null && _passcode.isNotEmpty ? 'パスコーの変更' : 'パスコード設定', 
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 20.0),),
  ...
  Future<void> _readPrefsData() async {
    ...
    setState(() {
      _hidesPasscode = (prefs.getBool('isPasscodeHidden') ?? true) ? _HidesPasscode.yes : _HidesPasscode.no;
  ...
  Future<void>  _savePrefsData({_HidesPasscode hidesPasscode}) async {
    ...
    setState(() {
      if(hidesPasscode != null) {
        ...
        prefs.setBool('isPasscodeHidden', hidesPasscode == _HidesPasscode.yes ? true : false);
      }
    });
  }
