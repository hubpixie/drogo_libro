...
class MyDrogoView extends StatefulWidget {
  final String title;
  MyDrogoView({required this.title});
...
class _MyDrogoViewState extends State<MyDrogoView> {
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.listupDrogo),
                      ),
                      Container(
                        width: screenWidth / 2,
                        color: Colors.indigo[200]?.withAlpha(200),
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.searchDrogo),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.addDrogoDetail),
                      ),
                      Container(
                        width: screenWidth,
                        height: screenHeight / 6,
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.editMyMemo),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.usingDrogo),
                      ),
                      Container(
                        width: screenWidth / 2,
                        color: Colors.indigo[600]?.withAlpha(200),
                        child: _buildFunctionButton(
                            context, FunctionButtonKind.showDrogoForgotHelp),
                      ),
                    ],
                  ),
                ),
  ...
  Widget _buildFunctionButton(
    ...
    return buttonKind == FunctionButtonKind.addDrogoDetail ||
            buttonKind == FunctionButtonKind.editMyMemo
  ...
  void _buttonOnTap(BuildContext context, FunctionButtonKind buttonKind) {
    switch (buttonKind) {
      ...
      case FunctionButtonKind.showDrogoForgotHelp:
        Navigator.pushNamed(
            context, ScreenRouteName.showDrogoForgotHelp.name ?? '');
        break;
      default:
        break;
    }
