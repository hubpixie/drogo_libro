    ...
    switch (sr) {
      case ScreenRouteName.myTabs:
        return MaterialPageRoute(
            builder: (_) => MyTabsContainer(), settings: settings);
      ...
      case ScreenRouteName.listupDrogo:
        return MaterialPageRoute(
            builder: (_) => DrogoListView(title: 'おくすり一覧'), settings: settings);
      case ScreenRouteName.searchDrogo:
        return MaterialPageRoute(
            builder: (_) => DrogoSearchView(title: 'おくすり検索'),
            settings: settings);
      ...
      case ScreenRouteName.editDrogoDetail:
        ...
        return MaterialPageRoute(
            builder: (_) => DrogoDetailView(
                drogoItem: args != null ? args["drogoItem"] : null),
            settings: settings);
      ...
      case ScreenRouteName.showDrogoForgotHelp:
        return MaterialPageRoute(
            builder: (_) => Scaffold(
                appBar: AppBar(
                  backgroundColor: Color(0xFF64B7DA),
                  title: Text('おくすりを飲み忘れたら'),
                ),
                body: Container()));
      case ScreenRouteName.presentForyouAll:
        return MaterialPageRoute(
            builder: (_) => ForyouPresentView(title: 'For you一覧'),
            settings: settings);
      ...
      case ScreenRouteName.editBloodType:
        return MaterialPageRoute(
            builder: (_) => ForyouEditContainer(
                  title: '血液型',
                  routeName: ScreenRouteName.editBloodType,
                ),
            settings: settings);
      case ScreenRouteName.editMedicalHistory:
        return MaterialPageRoute(
            builder: (_) => ForyouEditContainer(
                  title: '既往歴',
                  routeName: ScreenRouteName.editMedicalHistory,
                ),
            settings: settings);
      case ScreenRouteName.editAllergy:
        return MaterialPageRoute(
            builder: (_) => ForyouEditContainer(
                  title: 'アレルギー',
                  routeName: ScreenRouteName.editAllergy,
                ),
            settings: settings);
      case ScreenRouteName.editSuplements:
        return MaterialPageRoute(
            builder: (_) => ForyouEditContainer(
                  title: 'サプリメントなど',
                  routeName: ScreenRouteName.editSuplements,
                ),
            settings: settings);
      case ScreenRouteName.editSideEffect:
        return MaterialPageRoute(
            builder: (_) => ForyouEditContainer(
                  title: '副作用',
                  routeName: ScreenRouteName.editSideEffect,
                ),
            settings: settings);
      ...
      case ScreenRouteName.passcode:
        ...
        final Map<String, dynamic>? args =
            settings?.arguments as Map<String, dynamic>;
        return MaterialPageRoute(
            builder: (_) => PasscodePanel(
                  title: 'Passcode Lock Screen',
                  onValidate: (enteredValue) =>
                      StringUtil().encryptedPcode ==
                      StringUtil().encryptedString(enteredValue),
                  cancelable: (args == null) || (args['cancel'] as bool) == true
                      ? true
                      : false,
                ),
            settings: settings);
      case ScreenRouteName.changePasscodeSettings:
        return MaterialPageRoute(
            builder: (_) => PasscodeSettingsView(title: 'パスコード表示設定'),
            settings: settings);
      case ScreenRouteName.editPasscode:
        final Map<String, dynamic>? args =
            settings?.arguments as Map<String, dynamic>;
        return MaterialPageRoute(
            builder: (_) => PasscodeEditView(
                  title: 'パスコード入力・変更',
      ...
      case ScreenRouteName.selectCityFavorite:
        return MaterialPageRoute(
            builder: (_) => CityFavoritesView(title: 'お気に入り（地域）'),
            settings: settings);
      case ScreenRouteName.selectCountry:
        final Map<String, dynamic>? args =
            settings?.arguments as Map<String, dynamic>;
        return MaterialPageRoute(
            builder: (_) => CountrySelectorView(
                title: '国名コード',
